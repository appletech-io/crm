...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-stone-50 antialiased dark:bg-black">
        <div class="auth-card-glow flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
            ...
            >
                <div class="flex flex-col gap-6">
                    <div class="w-full bg-white shadow-xs ring-1 ring-gray-950/5 sm:rounded-2xl dark:bg-zinc-900 dark:ring-white/10">
