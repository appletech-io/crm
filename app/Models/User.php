 ...
 */
#[Fillable(['name', 'email', 'mobile', 'job_title', 'password', 'password_changed_at', 'requires_account_setup', 'company_id', 'candidate_id', 'candidate_type', 'client_contact_id', 'compliance_officer_id', 'dashboard_view'])]
