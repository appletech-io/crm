...
/** @see EducationReports for why this currently mirrors it exactly — Construction books temp work and places permanent roles the same way at the data level. */
class ConstructionReports implements ReportsInterface
{
