...
class HealthcareConsultantKpiOverview extends StatsOverviewWidget implements HasActions
{
    use InteractsWithActions;

    protected string $view = 'filament.widgets.healthcare-consultant-kpi-overview';
    ...
    private function cacheKey(string $suffix): string
    {
        ...
        return "healthcare-consultant-kpi:{$companyId}:{$consultantId}:{$suffix}:{$monthStart}";
    }
